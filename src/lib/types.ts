...
/**
 * The aftercare shapes live here, not in content.ts/music.ts, because an entry
 * stores what it was actually shown and those files already import from here.
 * They are type aliases rather than interfaces so they stay assignable to the
 * generated `Json` type when written to a jsonb column.
 */
